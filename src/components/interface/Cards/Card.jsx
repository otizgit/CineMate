    ...
    <div className="relative rounded-tr-xl rounded-tl-xl">
      ...
      {props.keyword === "person" ? null : (
        ...
        >
          ...
          />
          <span className={`hidden lg:group-hover:block absolute ${isMovieInWishlist ? "-bottom-[4.5rem]" : "-bottom-[3.2rem]"} bg-white px-4 py-1 z-10 custom-fz text-[0.8rem] font-semibold rounded-xl`}>
