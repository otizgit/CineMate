...
export default function Footer() {
  return (
    <motion.footer
      ...
      className="relative py-10 lg:py-8 bg-black"
    >
      <div className="max-width paddingX flex flex-col xl:flex-row xl:justify-between items-center xl:items-start justify-center gap-10">
        <div>
          <Link to="/home">
            <motion.img
              transition={{
